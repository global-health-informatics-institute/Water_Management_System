...
Tank1 = WaterTank(height=config["tank_height"],diameter=config["tank_diameter"],volume=config["tank_volume"],length=config["tank_length"], width=config["tank_width"],tank_type=config["tank_type"],trigger=5,echo=18)
