...
class Operation1:
    ...
    def __init__(self,tank_id = 0,pressure_sensor_pin = 32,tank_valve_pin = 23,secondary_valve_pin = 4,water_pump_pin = 2,pressure_pump_pin = 27,tank_volume = config["tank_volume"]):
    ...
    def getPressureReading(self):
        #Pressure Sensor
        pressure_raw = self.pressureSensor.pressure_150()
        pressure = round(pressure_raw,1)
...
class Operation2:
    ...
    def __init__(self,tank_id = 0,tank_outlet_pin = 23,tank_inlet_pin = 4,tank_volume = 20):
        ...
        # PIN ASSIGNMENT
        # **************************************************
        self.valveOut = machine.Pin(tank_outlet_pin,machine.Pin.OUT)
        self.valveIn = machine.Pin(tank_inlet_pin,machine.Pin.OUT)
    ...
    def operateSys(self):
        ...
        data = {"Volume":tankVolume ,"warning1":warning1,"warning2":warning2,"tank_id": tank_id,"opMode":config["operation mode"]}
        components = {"valve1":self.valveOut.value(),"valve2":self.valveIn.value(),"tank_id": tank_id,"opMode":config["operation mode"]}
