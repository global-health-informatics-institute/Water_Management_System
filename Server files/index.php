...
<html>
  ...
  <body>
    ...
    <div class="container-fluid row">
      ...
      <!--Card for tank 1-->
      <div id="the_container1" class="card col-lg-12 col-md-6 shadow-lg p-5">
        <!--Toggle and select-->
        <ul class="nav nav-2">
      ...
      <!--Card for tank 2-->
      <div id="the_container2" class="card col-lg-12 col-md-6 shadow-lg p-5">
        <!--Toggle and select-->
        <ul class="nav nav-2">
          <li class="nav-item text-start">
            <button id="mode" class="btn-nav button-30 me-2" onclick="handleClick5()">Auto-mode</button>
      ...
      <!--Card for tank 3-->
      <div id="the_container3" class="card col-lg-12 col-md-6 shadow-lg p-5">
        <!--Toggle and select-->
        <ul class="nav nav-2">
          <li class="nav-item text-start">
            <button id="mode" class="btn-nav button-30 me-2" onclick="handleClick5()">Auto-mode</button>
